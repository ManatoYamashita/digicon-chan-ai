...
function Profile({ title, subtitle, description }: Props) {
    return (
        <section>
            <div className={styles.card}>
                ...
                <div className={styles.bottomSection}>
                    ...
                    <div className={styles.item}>
                        <span className={styles.bigText}>2626</span>
                        <span className={styles.regularText}>UI elements</span>
                    </div>
                    <div className={styles.item}>
                        <span className={styles.bigText}>100%</span>
                        <span className={styles.regularText}>Free for use</span>
                    </div>
                    <div className={styles.item}>
                        <span className={styles.bigText}>38,631</span>
                        <span className={styles.regularText}>Contributors</span>
                    </div>
                    </div>
                </div>
            </div>
